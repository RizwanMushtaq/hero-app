    ...
    <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                <div>
                    <span class="text-gray-800">{{ feedback.user.name }}</span>
                ...
                <Dropdown v-if="feedback.user.id === $page.props.auth.user.id">
                    <template #trigger>
                        <button>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <template #content>
                        ...
                        <DropdownLink
                            as="button"
                            :href="route('feedbacks.destroy', feedback.id)"
                            method="delete"
                        >
                            Delete
                        </DropdownLink>
            ...
            <form
                v-if="editing"
                @submit.prevent="
                    form.put(route('feedbacks.update', feedback.id), {
